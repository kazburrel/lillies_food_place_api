            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    ...
                    <h3 class="card-title align-items-center flex-column">
                        <span class="card-label fw-bolder text-gray-800">ALL ORDERS</span>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex flex-stack flex-wrap gap-4">
                            <!--begin::Search-->
                            <form action="/admin/all_orders" class="d-flex align-items-center">
                        ...
                        @forelse ($orders as $order)
                            <tbody class="fw-bolder text-gray-600">
                                <tr class="mb-3">
                                    ...
                                    <td class="text-center border border-2">
                                        <span>{{ $order->customerDetails !== null ? $order->customerDetails->name : '' }}</span>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            <div class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                                ...
                                                data-bs-target="#kt_modal_add_user-{{ $order->unique_id }}">
                                            ...
                                            <div class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                                data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_block_user{{ $order->unique_id }}">
                                                <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                                            ...
                                            <a href="#" class="btn btn-icon btn-bg-light btn-sm"
                                                data-bs-toggle="modal" data-bs-target="#kt_modal_1{{ $order->unique_id }}"
                                ...
                                <div class="modal fade" tabindex="-1" id="kt_modal_1{{ $order->unique_id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content text-center">
                                            ...
                                            <div class="modal-footer d-flex justify-content-center">
                                                ...
                                                <x-delete href="/admin/all_users/{{ $order->unique_id }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade" id="kt_modal_add_user-{{ $order->unique_id }}"
                                    aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                ...
                                                <form id="kt_modal_new_target_form" class="form"
                                                    action="/admin/all_users/{{ $order->unique_id }}" method="POST"
                                                    ...
                                                    <div class="mb-13 text-center">
                                                        <!--begin::Title-->
                                                        <h1 class="mb-3">Update {{ $order->name }}
                                                            Details</h1>
                                                        <!--end::Title-->
                                                    </div>
                                                    <!--end::Heading-->
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid"
                                                            ...
                                                            value="{{ old('name') ?? $order->receiver_name }}" />
                                                        @error('name')
                                                            <p class="text-danger">
                                                                {{ $message }}
                                                            </p>
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <input type="address" class="form-control form-control-solid"
                                                            placeholder="Enter Department Name" name="address"
                                                            value="{{ old('address') ?? $order->receiver_address }}" />
                                                        @error('address')
                                                            <p class="text-danger">
                                                                {{ $message }}
                                                            </p>
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid"
                                                            ...
                                                            value="{{ old('mobile') ?? $order->receiver_phone }}" />
                                                        @error('mobile')
                                                            <p class="text-danger">
                                                                {{ $message }}
                                                            </p>
