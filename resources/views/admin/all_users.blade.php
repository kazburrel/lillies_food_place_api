                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3">
                        ...
                        @forelse ($users as $user)
                            <tbody class="fw-bolder text-gray-600">
                                ...
                                {{-- <div class="modal fade" tabindex="-1" id="kt_modal_block_user{{ $staff->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content text-center">
                                            ...
                                            <div class="modal-body">
                                                <p>Are you sure you want to {{ $staff->status == true ? 'block' : 'unblock' }}
                                                    staff?</p>
                                            </div>
                                            ...
                                            <div class="modal-footer d-flex justify-content-center">
                                                ...
                                                <x-block href="/admin/all_staff/{{ $staff->staff_id }}" :status="$staff->status" />
                                            </div>
                                        </div>
                                    </div>
                                </div> --}}
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content text-center">
                                            ...
                                            <div class="modal-footer d-flex justify-content-center">
                                                <button type="button" class="btn btn-light"
                                                    data-bs-dismiss="modal">Close</button>
                                                <x-delete href="/admin/all_staff/{{ $user->unique_id }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <form id="kt_modal_new_target_form" class="form"
                                                    ...
                                                    {{-- <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <input type="number" class="form-control form-control-solid"
                                                            ...
                                                            value="{{ old('mobile_no') ?? $staff->mobile_no }}" />
                                                        @error('mobile_no')
                                                            <p class="text-danger">
                                                                {{ $message }}
                                                            </p>
